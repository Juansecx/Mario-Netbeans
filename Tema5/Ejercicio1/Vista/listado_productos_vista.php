...
<html>
    ...
    <body class="pagproductos">
                    ...
                    <?php if (isset($array_productos)): ?>
                        <table>
                            ...
                            <?php foreach ($array_productos as $producto): ?>
                                <tr>
                                    <td>
                                        <form id='anadir' onsubmit="anadirProductos(this); return false" method='POST'>
                                            <input type="number" name='unidades' value='1' class="cantidad">
                                            <input type='submit' name='anadir' value='Añadir'/>
                                            <input type='hidden' name='cod_producto' value='<?= $producto->getCod() ?>'/>
                                        </form>
                                    </td>
        ...
        <?php endif ?>
        <script src="../../Tema6/cargarDatos.js"></script>
    </body>
</html>
